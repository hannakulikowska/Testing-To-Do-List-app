...
- [ ] "Delete Tasks" action removes all the tasks from the given list. 
...
**Expected Result:** The tasks related actions should be disabled if there are no tasks on the list.
...
**Expected Result:** The "Move list" actions should be disabled if there is the only one list on the board.
...
**Expected Result:** There is only one option on the actions menu to move the first list - only to the right. It works correctly.
